    ...
    <div className="playfair-display-400 text-justify mx-auto bg-white">
      ...
      <div className="max-w-screen-xl mx-auto text-black">
        <p className="text-[18px] pt-4 px-8 md:px-32">
          Welcome to <span className="font-bold ">Amber & Co!</span> Where the
          art of jewelry transcends mere adornment. We believe in crafting
          pieces that tell stories, celebrate milestones, and become cherished
          heirlooms. Discover the heart behind our creations and the journey
        ...
        <p className="text-[18px] px-8 md:px-32">
          ...
          connection. We believe in the power of jewelry to express
          individuality and create lasting memories. We are committed to ethical
          sourcing, sustainable practices, and building genuine relationships
          with our customers, ensuring that every interaction reflects the
          warmth and authenticity that defines{" "}
          <span className="font-bold ">Amber & Co</span>.
        </p>{" "}
        <br />
        ...
        <p className="text-[18px] px-8 md:px-32">
          ...
          Together, we are committed to creating jewelry that not only dazzles
          but also resonates with the values of craftsmanship, sustainability,
