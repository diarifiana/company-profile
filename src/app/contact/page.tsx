  ...
  return (
    <div className="playfair-display-400 text-justify">
      ...
      <p className="text-[18px] px-8 md:px-32">
        ...
        order has shipped.
        <br /> <br />
        We offer a 24-hours return policy on all unworn and undamaged items. To
        initiate a return, please contact our customer service team. If you'd
        like to exchange an item, please contact our customer service team.
        We'll assist you with the exchange process. All refunds will be
        processed to the original payment method within 5-7 business days of
        receiving the returned item.
      </p>{" "}
      <h3 className="font-bold text-xl pt-12 pb-4 px-8 md:px-32">Jewelry Care</h3>
      <p className="text-[18px] px-8 md:px-32">
        ...
        <ul className="text-[18px] px-8 md:text-left md:px-0">
          <li>
            ...
            sunlight and extreme temperatures. Use individual pouches or jewelry
            boxes to prevent scratches and tangling
          </li><br/>
          <li>
            #2 Avoid exposing your jewelry to harsh chemicals, such as perfumes,
            lotions, and cleaning products. Remove your jewelry before swimming,
            showering, or exercising.
          </li><br/>
          <li>
            #3 Gently clean your jewelry with a soft cloth after each wear. For
            deeper cleaning, use a mild soap and warm water solution.
          </li>
        </ul>
      </p>{" "}
    </div>
