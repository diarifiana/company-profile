...
const ProductPage = () => {
  ...
  return (
    <div
      className="playfair-display-400 w-full min-h-screen bg-white text-gray-700 dark:bg-white overflow-hidden"
      style={{ backgroundColor: "white" }}
    >
      <h2 className="text-3xl font-bold text-center pb-8 text-[#c8b97e] dark:text-[#d2c286]">
        Our Products
      </h2>
      <div className="container mx-auto">
        <div className="mx-4 space-y-4">
          {products.map((product) => (
            <div
              key={product.id}
              className="grid md:grid-cols-2 gap-4 py-4 items-center"
            >
              <div>
                <img
                  src={product.src}
              ...
              <div className="py-4">
                ...
                <h2 className="text-xl font-semibold mb-4 text-[#c8b97e] dark:text-[#d2c286]">
                  History
                </h2>
                <p className="mb-6">{product.history}</p>

                <h2 className="text-xl font-semibold mb-4 text-[#c8b97e] dark:text-[#d2c286]">
                  Crafting
                </h2>
                <p className="mb-6">{product.crafting}</p>
                ...
                >
                  <button className="bg-[#c8b97e] hover:bg-white hover:text-[#c8b97e] text-white font-bold py-2 px-4 rounded dark:bg-[#d2c286] dark:hover:bg-gray-800 dark:hover:text-[#d2c286]">
                    Shop Now
                  </button>
                </a>
              </div>
