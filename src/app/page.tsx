...
const AboutUsText = () => (
  <div className="p-8 md:px-32 text-lg text-justify bg-white max-w-screen-xl text-black mx-auto">
    <p>
      ...
      satisfaction. We continue to evolve, always striving to create pieces that
      inspire and delight.
    </p>
    <br />
    <p>
      Our culture is woven with the same threads of beauty, passion, and
      artistry. We believe in fostering a creative and collaborative environment
      where every artisan is empowered to express their unique vision,
      prioritize ethical sourcing, meticulous craftsmanship, and a genuine love
      for the stories our jewelry tells. We strive to create a workplace where
      inspiration flourishes, and every piece reflects the heart of our
      collective dedication to creating timeless treasures.
    </p>
  </div>
);
